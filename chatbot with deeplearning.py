...
#Create Chat window
ChatLog = Text(base, bd=0, bg="#ebebed", height="8", width="50", font="Arial",)
...
SendButton_2 = Button(base, font=("Verdana",12,'bold'), text="MIC", width="12", height=2,
...
SendButton_2.place(x=6, y=450, height=45)
base.mainloop()